...
public class BlogEntryController {
    ...
    public ResponseEntity<PaginatedBlogEntriesResponseDto> getAllBlogEntriesForUser(
            Pageable pageable, Principal principal, @ModelAttribute BlogEntryFilterRequest blogEntryFilter)
    {
    ...
    public ResponseEntity<?> createBlogEntry(
            @RequestBody @Valid BlogEntryRequestDto blogEntryRequestDto, Principal principal, UriComponentsBuilder ucb)
    {
    ...
    public ResponseEntity<?> updateBlogEntry(
            @PathVariable Integer id, @RequestBody @Valid BlogEntryRequestDto blogEntryRequestDto, Principal principal)
    {
